      ...
      setMessages([
        {
          ...
          sender: 'bot',
          text: 'Здравствуйте! Добро пожаловать в SilverByte 👋\n\nЯ помогу вам с вопросами по заказам, доставке, оплате, аккаунту, гарантии и геймификации.\n\nВыберите интересующую тему ниже. Если вашего вопроса нет в списке, нажмите кнопку «Поддержка» и опишите проблему подробнее.',
          options: chatbotData,
        },
      ]);
    }
